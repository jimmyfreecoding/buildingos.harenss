...
| v1.0 | **M0 wrap-up**: configs review — 3 decisions settled (unified vocabulary / no exception channel / memory placeholder); [契约哲学.md](../契约哲学.md) added (plain-language memo of all 15 M0 decisions, D1–D15) — now at [docs/contract-philosophy.md](contract-philosophy.md) |
